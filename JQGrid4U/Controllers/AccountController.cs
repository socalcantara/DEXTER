...
namespace JQGrid4U.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		public ActionResult Login(string returnUrl)
		{
			...
			//int xcounter = 0;
			//int xdelay = 0;
			//  UserLogFailBL.FailedCounterIP(vIPadd);
		...
		public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
		{
			...
			if (ModelState.IsValid)
			{
				...
				Boolean isDisabled = UserBL.isAcctDisabled(model.UserName);
				if (isDisabled == true)
				{
				...
				else
				{
					...
					if (IsValid == true)
					{
                        ...
                        Session["userid"] = Session["rowfilter"] = UserBL.Users.SingleOrDefault(x => x.EmailAdd == username).userID;
